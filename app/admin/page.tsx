...
async function getDevicesForHeatmap(): Promise<DeviceCell[]> {
  // Fetch recent results and dedup by device_id in JS (DISTINCT ON not available via JS client)
  ...
  // Get download baselines for all devices
  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h2 className="text-base font-semibold text-gray-900 mb-4">Device Health</h2>
